...
## This is here so configs done via GUI are still loaded.
## Remove it to not load settings done via the GUI.
config.load_autoconfig()

## Aliases for commands. The keys of the given dictionary are the
## aliasses, while the values are the commands they map to.
## Type: Dict
#c.aliases = {'w': 'session-save', 'q', 'quit', 'wq': 'quit --save'}

## How ofren (in milliseconds) to auto-save config/cookies/etc.
## Type: Int
...
## Type: List of Url
c.content.blocking.hosts.lists = ['https://www.malwaredomainlist.com/hostslist/hosts.txt', 'http://someonewhocares.org/hosts/hosts', 'http://winhelp2002.mvps.org/hosts.zip', 'https://pgl.yoyo.org/adservers/serverlist.php?hostformat=hosts&mimetype=plaintext']
...
##   - ask-block-thirdparty: asks for page loads but automatically blocks resource
##     loads on TLS errors. Behaviour consistant with other browsers.
...
## Type: Font
c.fonts.completion.category = 'bold 13pt JetBrainsMonoMedium Nerd Font'
...
## Type: Font
c.fonts.completion.entry = '13pt JetBrainsMonoMedium Nerd Font'

## Font used for the downloadbar.
## Type: Font
c.fonts.downloads = '13pt JetBrainsMonoMedium Nerd Font'

## Font used for the hints.
## Type: Font
c.fonts.hints = 'bold 13pt JetBrainsMonoMedium Nerd Font'

## Font used in the keyhint widget.
## Type: Font
c.fonts.keyhint = '13pt JetBrainsMonoMedium Nerd Font'

## Font used for error messages.
## Type: Font
c.fonts.messages.error = '13pt JetBrainsMonoMedium Nerd Font'

## Font used for info messages.
## Type: Font
c.fonts.messages.info = '13pt JetBrainsMonoMedium Nerd Font'

## Font used for warning messages.
## Type: Font
c.fonts.messages.warning = '13pt JetBrainsMonoMedium Nerd Font'

## Default monospace fonts. Whenever "monospace" is used in a font
## setting, it's replaced with the fonts listed here.
## Type: Font
#c.fonts.monospace = '"Comic Mono", "Liberation Mono"'

## Font used for prompts.
## Type: Font
c.fonts.prompts = '13pt JetBrainsMonoMedium Nerd Font'

## Font used in the statusbar.
## Type: Font
c.fonts.statusbar = '13pt JetBrainsMonoMedium Nerd Font'
...
c.url.searchengines = {
        ...
        'fit': 'https://fitgirl-repacks.site/?s={}',
        ...
        'ge': 'https://earth.google.com/web/search/{}',
        ...
        'sm': 'https://maps.secondlife.com/index.php?q={}&s=Places',
...
## Bindings for CSS stylesheets
config.bind(',qu', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/css/cube/cube-all-sites.css ""')
...
## Render all colors as greyscale
## Type: Bool
c.colors.webpage.darkmode.grayscale.all = True

## Preferred color setting for webpages
## Type: String
## Valid values:
## - auto
## - dark
